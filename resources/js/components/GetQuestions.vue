    ...
    <section class="body-font">
        <div class="container px-5 mx-auto">
            <div class="flex flex-wrap -m-4">
                <div class="p-4 lg:w-1/3 w-full" v-for="(question, index) in this.questions" :key="index">
                    ...
                    <a class="text-indigo-500 inline-flex items-center" v-if="question.status == 0">
                        <inertia-link
                    ...
                    <a class="text-indigo-500 inline-flex items-center" v-if="question.status == 1">
                        <inertia-link
                            :href="route('question.edit', question.id)"
                        >
                            <button
                                class="bg-blue-400 text-white px-4 py-2 border rounded-md hover:bg-white hover:border-indigo-500 hover:text-black"
                            >
                                編集する
                            </button>
                        </inertia-link>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData: function(){
              axios.post(route("question.getJSON", {"type": this.type}))
                .then(response => {
