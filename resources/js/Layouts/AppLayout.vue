                        ...
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <inertia-link :href="route('dashboard')">
                                    ...
                                    <!-- <img src="storage/logos/logo.png" alt="logo" class="block h-9 w-auto"> -->
                                </inertia-link>
                            </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            <jet-responsive-nav-link :href="route('question.index')" :active="route().current('question.index')">
                                質問一覧
                            </jet-responsive-nav-link>
                            ...
                            <jet-responsive-nav-link :href="route('analyze.index')" :active="route().current('analyze.index')">
                                分析
                            </jet-responsive-nav-link>
